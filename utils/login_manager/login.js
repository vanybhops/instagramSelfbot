...
const {encrypt, format, info} = require("../password_manager/index");
/**
 * Description - Authenticates a user with instagram's custom encryption and logs them in.
...
module.exports = async ( username, password )=>{
    ...
    let response = await request.send("https://www.instagram.com/api/v1/web/accounts/login/ajax/", {
        "headers": {
